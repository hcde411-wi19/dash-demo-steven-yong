    ...
    dcc.Graph(
        ...
        figure={
            ...
            'data': [
                ...
                {'x': weekday_in_order, 'y': ped_s, 'type': 'bar', 'name': 'Pedestrian (South)'},
                {'x': weekday_in_order, 'y': ped_n, 'type': 'bar', 'name': 'Pedestrian (North)'},
                {'x': weekday_in_order, 'y': bike_s, 'type': 'bar', 'name': 'Bike (South)'},
                {'x': weekday_in_order, 'y': bike_n, 'type': 'bar', 'name': 'Bike (North)'},
